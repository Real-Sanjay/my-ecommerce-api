        ...
        uploadProduct.fields([
            ...
            fields.forEach((field, index) => {
                if (req.files[field] && req.files[field].length > 0) {
                    ...
                    const imageUrl = `https://sanjaydh.com/image/products/${file.filename}`;
...
//         cb(null, 'public/products'); // Set your desired upload destination
//     },
...
//                 if (req.files[field] && req.files[field].length > 0) {
//                     const file = req.files[field][0];
//                     const imageUrl = `https://sanjaydh.com/image/products/${file.originalname}`;
//                     imageUrls.push({ image: index + 1, url: imageUrl });
//                 }
//             });
