...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://sanjaydh.com/image/category/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://sanjaydh.com/image/category/${req.file.filename}`;
            }
...
//         cb(null, 'public/category'); // Set your desired upload destination
//     },
...
//             let imageUrl = 'no_url';
//             if (req.file) {
//                 imageUrl = `https://sanjaydh.com/image/category/${req.file.originalname}`;
//             }
//             console.log('url ', req.file);
...
//             if (req.file) {
//                 image = `https://sanjaydh.com/image/category/${req.file.originalname}`;
//             }
